...
def ant_dir(seed, log_id, gpu_id):
	...
	--unbounded_eval_hist  --hiddens_context 30  --num_tasks_sample 5 --burn_in  10000 \
...
def humanoid_dir(seed, log_id, gpu_id):
	...
	--hiddens_context 20   --num_tasks_sample 1 --burn_in  10000 --batch_size 256 \
...
def cheetah_vel(seed, log_id, gpu_id):
	...
	--hiddens_context 15   --num_tasks_sample 1 --burn_in  10000 --batch_size 256 \
...
def cheetah_dir(seed, log_id, gpu_id):
	...
	--lam_csc  0.5  --snapshot_size 2000 --hiddens_context 20  --lr  0.0003 \
...
def ant_goal(seed, log_id, gpu_id):
	...
	--hiddens_context 40   --num_tasks_sample 5 --burn_in  10000 --batch_size 256 \
	--policy_noise 0.3 --eval_freq 10000 --replay_size 1000000 "+ \
	' --log_id ' + log_id + ' --seed ' + str(seed) + ' --gpu_id ' + str(gpu_id)
	return cmd
...
def walker_rand_params(seed, log_id, gpu_id):
	...
	--snap_iter_nums 10 --hidden_sizes  300 300  --lam_csc  0.06  --snapshot_size 4000 --hiddens_context 30  \
