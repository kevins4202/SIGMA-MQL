...
#context
parser.add_argument('--hiddens_context', nargs='+', type=int, default = [30], help = 'indicates hidden size of context next')
parser.add_argument('--enable_context', default=True, action='store_true')
parser.add_argument('--only_concat_context', type=int, default = 3, help =' use context')
...
if __name__ == "__main__":
    ...
    if len(env.observation_space.shape) == 1:
        ...
        if args.enable_context == True:
            ...
            args.output_dim_context =  (env.action_space.shape[0] + reward_dim) * 2
            ...
            if args.only_concat_context == 3: # means use LSTM with action_reward_state as an input
                ...
                actor_idim = [env.observation_space.shape[0] + args.hiddens_context[0]]
